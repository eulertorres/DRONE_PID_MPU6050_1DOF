...
void loop(){
  ...
  if (start == 2){                                                          // Motores estão armados
    ...
    esc_1 = throttle - pid_output_pitch + pid_output_roll; // Esc 1: Frontal -direito  - anti-horário	  ||	              							||
    esc_2 = throttle + pid_output_pitch + pid_output_roll; // Esc 2: Traseiro direito -  horário		    || IMPORTANTE SEGUIR ESSA ORDEM ||
    esc_3 = throttle + pid_output_pitch; // Esc 3: Direito
    esc_4 = throttle - pid_output_pitch; // Esc 4: Esquerdo
